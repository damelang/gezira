...
gezira_JoinOffsets_prologue (nile_Process_t *p, nile_Buffer_t *out)
{
    ...
    v.v_C_x = t_43_x;
    v.v_C_y = t_43_y;
    nile_Real_t t_45 = nile_Real_sub(v.v_u_y, v.v_v_y);
    nile_Real_t t_46 = nile_Real_sub(v.v_v_x, v.v_u_x);
    ...
    nile_Real_t t_74 = nile_Real (0.01);
    nile_Real_t t_75 = nile_Real_neg(t_74);
    nile_Real_t t_76 = nile_Real_lt(t_73, t_75);
    if (nile_Real_nz (t_76)) {
        nile_Real_t t_78 = nile_Real_add(v.v_A_x, v.v_C_x);
        nile_Real_t t_79 = nile_Real (2);
        nile_Real_t t_80 = nile_Real_div(t_78, t_79);
        nile_Real_t t_81 = nile_Real_add(v.v_A_y, v.v_C_y);
        ...
        nile_Real_t t_85_x = t_84_1;
        nile_Real_t t_85_y = t_84_2;
        nile_Real_t t_77_1_x = v.v_A_x;
        nile_Real_t t_77_1_y = v.v_A_y;
        nile_Real_t t_77_2_x = t_85_x;
        nile_Real_t t_77_2_y = t_85_y;
        nile_Real_t t_77_3_x = v.v_C_x;
        nile_Real_t t_77_3_y = v.v_C_y;
        ...
        nile_Real_t t_87 = nile_Real_mul(v.v_u_x, v.v_w_x);
        nile_Real_t t_88 = nile_Real_mul(v.v_u_y, v.v_w_y);
        nile_Real_t t_89 = nile_Real_add(t_87, t_88);
        nile_Real_t t_90 = nile_Real (0.9);
        nile_Real_t t_91 = nile_Real_lt(t_89, t_90);
        if (nile_Real_nz (t_91)) {
            ; /* no-op */
            nile_Process_t *t_92 = gezira_JoinOffsets(p, nile_Real_tof (v.v_o), nile_Real_tof (v.v_P_x), nile_Real_tof (v.v_P_y), nile_Real_tof (v.v_u_x), nile_Real_tof (v.v_u_y), nile_Real_tof (v.v_w_x), nile_Real_tof (v.v_w_y));
            nile_Process_t *t_93 = gezira_JoinOffsets(p, nile_Real_tof (v.v_o), nile_Real_tof (v.v_P_x), nile_Real_tof (v.v_P_y), nile_Real_tof (v.v_w_x), nile_Real_tof (v.v_w_y), nile_Real_tof (v.v_v_x), nile_Real_tof (v.v_v_y));
            nile_Process_t *t_94 = nile_Process_pipe (t_92, t_93, NILE_NULL);
            return nile_Process_swap (p, t_94, out);
        }
        else {
            nile_Real_t t_95_x = v.v_o;
            nile_Real_t t_95_y = v.v_o;
            nile_Real_t t_96_x = nile_Real_mul(t_95_x, v.v_w_x);
            nile_Real_t t_96_y = nile_Real_mul(t_95_y, v.v_w_y);
            nile_Real_t t_97_x = t_96_x;
            nile_Real_t t_97_y = t_96_y;
            nile_Real_t t_98_x = nile_Real_add(v.v_P_x, t_97_x);
            nile_Real_t t_98_y = nile_Real_add(v.v_P_y, t_97_y);
            nile_Real_t v_N_x = t_98_x;
            nile_Real_t v_N_y = t_98_y;
            nile_Real_t t_99 = nile_Real (2);
            nile_Real_t t_100_x = t_99;
            nile_Real_t t_100_y = t_99;
            nile_Real_t t_101_x = nile_Real_mul(t_100_x, v_N_x);
            nile_Real_t t_101_y = nile_Real_mul(t_100_y, v_N_y);
            nile_Real_t t_102 = nile_Real_add(v.v_A_x, v.v_C_x);
            nile_Real_t t_103 = nile_Real (2);
            nile_Real_t t_104 = nile_Real_div(t_102, t_103);
            nile_Real_t t_105 = nile_Real_add(v.v_A_y, v.v_C_y);
            nile_Real_t t_106 = nile_Real (2);
            nile_Real_t t_107 = nile_Real_div(t_105, t_106);
            nile_Real_t t_108_1 = t_104;
            nile_Real_t t_108_2 = t_107;
            nile_Real_t t_109_x = t_108_1;
            nile_Real_t t_109_y = t_108_2;
            nile_Real_t t_110_x = nile_Real_sub(t_101_x, t_109_x);
            nile_Real_t t_110_y = nile_Real_sub(t_101_y, t_109_y);
            nile_Real_t v_B_x = t_110_x;
            nile_Real_t v_B_y = t_110_y;
            nile_Real_t t_111_1_x = v.v_A_x;
            nile_Real_t t_111_1_y = v.v_A_y;
            nile_Real_t t_111_2_x = v_B_x;
            nile_Real_t t_111_2_y = v_B_y;
            nile_Real_t t_111_3_x = v.v_C_x;
            nile_Real_t t_111_3_y = v.v_C_y;
            nile_Real_t t_112_A_x = t_111_1_x;
            nile_Real_t t_112_A_y = t_111_1_y;
            nile_Real_t t_112_B_x = t_111_2_x;
            nile_Real_t t_112_B_y = t_111_2_y;
            nile_Real_t t_112_C_x = t_111_3_x;
            nile_Real_t t_112_C_y = t_111_3_y;
            if (nile_Buffer_tailroom (out) < OUT_QUANTUM)
                out = nile_Process_append_output (p, out);
            nile_Buffer_push_tail(out, t_112_A_x);
            nile_Buffer_push_tail(out, t_112_A_y);
            nile_Buffer_push_tail(out, t_112_B_x);
            nile_Buffer_push_tail(out, t_112_B_y);
            nile_Buffer_push_tail(out, t_112_C_x);
            nile_Buffer_push_tail(out, t_112_C_y);
        }
    }
    *vars = v;
    return out;
...
gezira_OffsetAndJoinBezierPath_epilogue (nile_Process_t *p, nile_Buffer_t *out)
{
    gezira_OffsetAndJoinBezierPath_vars_t *vars = nile_Process_vars (p);
    gezira_OffsetAndJoinBezierPath_vars_t v = *vars;
    nile_Real_t t_66 = nile_Real_neq(v.v_Bi_C_x, v.v_B0_A_x);
    nile_Real_t t_67 = nile_Real_neq(v.v_Bi_C_y, v.v_B0_A_y);
    nile_Real_t t_68 = nile_Real_or(t_66, t_67);
    nile_Real_t v_cap = t_68;
    nile_Real_t t_69_x = nile_Real_neg(v.v_u_x);
    nile_Real_t t_69_y = nile_Real_neg(v.v_u_y);
    nile_Real_t t_71 = nile_Real_sub(v.v_B0_A_y, v.v_B0_B_y);
    nile_Real_t t_72 = nile_Real_sub(v.v_B0_B_x, v.v_B0_A_x);
    ...
    nile_Real_t t_90_x = v_cap;
    nile_Real_t t_90_y = v_cap;
    nile_Real_t t_91_x = nile_Real_nz (t_90_x) ? t_69_x : t_89_x;
    nile_Real_t t_91_y = nile_Real_nz (t_90_y) ? t_69_y : t_89_y;
    nile_Real_t v_vv_x = t_91_x;
    nile_Real_t v_vv_y = t_91_y;
    ; /* no-op */
    nile_Process_t *t_92 = gezira_JoinOffsets(p, nile_Real_tof (v.v_o), nile_Real_tof (v.v_BiC_x), nile_Real_tof (v.v_BiC_y), nile_Real_tof (v.v_u_x), nile_Real_tof (v.v_u_y), nile_Real_tof (v_vv_x), nile_Real_tof (v_vv_y));
    nile_Process_t *t_93 = gezira_OffsetBezier(p, nile_Real_tof (v.v_o), nile_Real_tof (v.v_Bi_A_x), nile_Real_tof (v.v_Bi_A_y), nile_Real_tof (v.v_Bi_B_x), nile_Real_tof (v.v_Bi_B_y), nile_Real_tof (v.v_Bi_C_x), nile_Real_tof (v.v_Bi_C_y));
    nile_Process_t *t_94 = nile_Process_pipe (t_92, t_93, NILE_NULL);
    return nile_Process_swap (p, t_94, out);
    return out;
}
                                ...
                                nile_Buffer_t *out)
{
    ...
    while (!nile_Buffer_is_empty (in) && !nile_Buffer_quota_hit (out)) {
        ...
        if (nile_Real_nz (t_54)) {
            nile_Real_t t_56 = nile_Real_add(v_A_x, v_C_x);
            nile_Real_t t_57 = nile_Real (2);
            nile_Real_t t_58 = nile_Real_div(t_56, t_57);
            nile_Real_t t_59 = nile_Real_add(v_A_y, v_C_y);
            nile_Real_t t_60 = nile_Real (2);
            nile_Real_t t_61 = nile_Real_div(t_59, t_60);
            nile_Real_t t_62_1 = t_58;
            nile_Real_t t_62_2 = t_61;
            nile_Real_t t_63_x = t_62_1;
            nile_Real_t t_63_y = t_62_2;
            nile_Real_t t_55_1_x = v_A_x;
            nile_Real_t t_55_1_y = v_A_y;
            nile_Real_t t_55_2_x = t_63_x;
            nile_Real_t t_55_2_y = t_63_y;
            nile_Real_t t_55_3_x = v_C_x;
            nile_Real_t t_55_3_y = v_C_y;
            nile_Real_t t_64_A_x = t_55_1_x;
            nile_Real_t t_64_A_y = t_55_1_y;
            nile_Real_t t_64_B_x = t_55_2_x;
            nile_Real_t t_64_B_y = t_55_2_y;
            nile_Real_t t_64_C_x = t_55_3_x;
            nile_Real_t t_64_C_y = t_55_3_y;
            if (nile_Buffer_headroom (in) < IN_QUANTUM)
                in = nile_Process_prefix_input (p, in);
            nile_Buffer_push_head(in, t_64_C_y);
            nile_Buffer_push_head(in, t_64_C_x);
            nile_Buffer_push_head(in, t_64_B_y);
            nile_Buffer_push_head(in, t_64_B_x);
            nile_Buffer_push_head(in, t_64_A_y);
            nile_Buffer_push_head(in, t_64_A_x);
        }
        else {
            nile_Real_t t_65 = nile_Real (0);
            nile_Real_t t_66_x = t_65;
            nile_Real_t t_66_y = t_65;
            nile_Real_t t_67 = nile_Real_neq(v_u_x, t_66_x);
            nile_Real_t t_68 = nile_Real_neq(v_u_y, t_66_y);
            nile_Real_t t_69 = nile_Real_or(t_67, t_68);
            nile_Real_t t_70 = nile_Real (0);
            nile_Real_t t_71_x = t_70;
            nile_Real_t t_71_y = t_70;
            nile_Real_t t_72 = nile_Real_neq(v_v_x, t_71_x);
            nile_Real_t t_73 = nile_Real_neq(v_v_y, t_71_y);
            nile_Real_t t_74 = nile_Real_or(t_72, t_73);
            nile_Real_t t_75 = nile_Real_and(t_69, t_74);
            if (nile_Real_nz (t_75)) {
                nile_Real_t t_76_1_x = v_A_x;
                nile_Real_t t_76_1_y = v_A_y;
                nile_Real_t t_76_2_x = v_B_x;
                nile_Real_t t_76_2_y = v_B_y;
                nile_Real_t t_76_3_x = v_C_x;
                nile_Real_t t_76_3_y = v_C_y;
                nile_Real_t t_77_A_x = t_76_1_x;
                nile_Real_t t_77_A_y = t_76_1_y;
                nile_Real_t t_77_B_x = t_76_2_x;
                nile_Real_t t_77_B_y = t_76_2_y;
                nile_Real_t t_77_C_x = t_76_3_x;
                nile_Real_t t_77_C_y = t_76_3_y;
                if (nile_Buffer_tailroom (out) < OUT_QUANTUM)
                    out = nile_Process_append_output (p, out);
                nile_Buffer_push_tail(out, t_77_A_x);
                nile_Buffer_push_tail(out, t_77_A_y);
                nile_Buffer_push_tail(out, t_77_B_x);
                nile_Buffer_push_tail(out, t_77_B_y);
                nile_Buffer_push_tail(out, t_77_C_x);
                nile_Buffer_push_tail(out, t_77_C_y);
            }
            else {
                nile_Real_t t_79 = nile_Real_sub(v_A_y, v_M_y);
                nile_Real_t t_80 = nile_Real_sub(v_M_x, v_A_x);
                nile_Real_t t_78_1 = t_79;
                nile_Real_t t_78_2 = t_80;
                nile_Real_t t_81_x = t_78_1;
                nile_Real_t t_81_y = t_78_2;
                ...
                nile_Real_t t_85 = nile_Real_sqt(t_84);
                nile_Real_t t_86 = nile_Real (0);
                ...
                nile_Real_t t_91 = nile_Real_sqt(t_90);
                ...
                nile_Real_t t_97_x = nile_Real_nz (t_96_x) ? t_93_x : t_95_x;
                nile_Real_t t_97_y = nile_Real_nz (t_96_y) ? t_93_y : t_95_y;
                nile_Real_t t_98 = nile_Real (0);
                nile_Real_t t_99_x = t_98;
                nile_Real_t t_99_y = t_98;
                nile_Real_t t_100 = nile_Real_neq(t_97_x, t_99_x);
                nile_Real_t t_101 = nile_Real_neq(t_97_y, t_99_y);
                nile_Real_t t_102 = nile_Real_or(t_100, t_101);
                nile_Real_t t_104 = nile_Real_sub(v_M_y, v_C_y);
                nile_Real_t t_105 = nile_Real_sub(v_C_x, v_M_x);
                nile_Real_t t_103_1 = t_104;
                nile_Real_t t_103_2 = t_105;
                nile_Real_t t_106_x = t_103_1;
                nile_Real_t t_106_y = t_103_2;
                nile_Real_t t_107 = nile_Real_mul(t_106_x, t_106_x);
                nile_Real_t t_108 = nile_Real_mul(t_106_y, t_106_y);
                nile_Real_t t_109 = nile_Real_add(t_107, t_108);
                nile_Real_t t_110 = nile_Real_sqt(t_109);
                nile_Real_t t_111 = nile_Real (0);
                nile_Real_t t_112 = nile_Real_neq(t_110, t_111);
                nile_Real_t t_113 = nile_Real_mul(t_106_x, t_106_x);
                nile_Real_t t_114 = nile_Real_mul(t_106_y, t_106_y);
                nile_Real_t t_115 = nile_Real_add(t_113, t_114);
                nile_Real_t t_116 = nile_Real_sqt(t_115);
                nile_Real_t t_117_x = t_116;
                nile_Real_t t_117_y = t_116;
                nile_Real_t t_118_x = nile_Real_div(t_106_x, t_117_x);
                nile_Real_t t_118_y = nile_Real_div(t_106_y, t_117_y);
                nile_Real_t t_119 = nile_Real (0);
                nile_Real_t t_120_x = t_119;
                nile_Real_t t_120_y = t_119;
                nile_Real_t t_121_x = t_112;
                nile_Real_t t_121_y = t_112;
                nile_Real_t t_122_x = nile_Real_nz (t_121_x) ? t_118_x : t_120_x;
                nile_Real_t t_122_y = nile_Real_nz (t_121_y) ? t_118_y : t_120_y;
                nile_Real_t t_123 = nile_Real (0);
                nile_Real_t t_124_x = t_123;
                nile_Real_t t_124_y = t_123;
                nile_Real_t t_125 = nile_Real_neq(t_122_x, t_124_x);
                nile_Real_t t_126 = nile_Real_neq(t_122_y, t_124_y);
                nile_Real_t t_127 = nile_Real_or(t_125, t_126);
                nile_Real_t t_128 = nile_Real_and(t_102, t_127);
                if (nile_Real_nz (t_128)) {
                    nile_Real_t t_129_1_x = v_A_x;
                    nile_Real_t t_129_1_y = v_A_y;
                    nile_Real_t t_129_2_x = v_M_x;
                    nile_Real_t t_129_2_y = v_M_y;
                    nile_Real_t t_129_3_x = v_C_x;
                    nile_Real_t t_129_3_y = v_C_y;
                    nile_Real_t t_130_A_x = t_129_1_x;
                    nile_Real_t t_130_A_y = t_129_1_y;
                    nile_Real_t t_130_B_x = t_129_2_x;
                    nile_Real_t t_130_B_y = t_129_2_y;
                    nile_Real_t t_130_C_x = t_129_3_x;
                    nile_Real_t t_130_C_y = t_129_3_y;
                    if (nile_Buffer_tailroom (out) < OUT_QUANTUM)
                        out = nile_Process_append_output (p, out);
                    nile_Buffer_push_tail(out, t_130_A_x);
                    nile_Buffer_push_tail(out, t_130_A_y);
                    nile_Buffer_push_tail(out, t_130_B_x);
                    nile_Buffer_push_tail(out, t_130_B_y);
                    nile_Buffer_push_tail(out, t_130_C_x);
                    nile_Buffer_push_tail(out, t_130_C_y);
                }
                else {
                    ; /* no-op */
                }
