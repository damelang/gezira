...
static nile_Kernel_t *gezira_TransformBezier_clone(nile_t *nl, nile_Kernel_t *k_) {
...
nile_Kernel_t *gezira_TransformBezier(nile_t *nl, 
                                      nile_Real_t v_m_a, 
                                      nile_Real_t v_m_b, 
                                      nile_Real_t v_m_c, 
                                      nile_Real_t v_m_d, 
...
static int gezira_TransformBezier_process(nile_t *nl,
                                          nile_Kernel_t *k_,
                                          nile_Buffer_t **in_,
                                          nile_Buffer_t **out_) {
    #define IN_QUANTUM 6
...
static nile_Kernel_t *gezira_ClipBezier_clone(nile_t *nl, nile_Kernel_t *k_) {
...
nile_Kernel_t *gezira_ClipBezier(nile_t *nl, 
                                 nile_Real_t v_min_x, 
                                 nile_Real_t v_min_y, 
                                 nile_Real_t v_max_x, 
                                 nile_Real_t v_max_y) {
...
static int gezira_ClipBezier_process(nile_t *nl,
                                     nile_Kernel_t *k_,
                                     nile_Buffer_t **in_,
                                     nile_Buffer_t **out_) {
    #define IN_QUANTUM 6
...
static nile_Kernel_t *gezira_DecomposeBezier_clone(nile_t *nl, nile_Kernel_t *k_) {
...
nile_Kernel_t *gezira_DecomposeBezier(nile_t *nl) {
    gezira_DecomposeBezier_t *k = NILE_KERNEL_NEW(nl, gezira_DecomposeBezier);
    return (nile_Kernel_t *) k;
}

static int gezira_DecomposeBezier_process(nile_t *nl,
                                          nile_Kernel_t *k_,
                                          nile_Buffer_t **in_,
                                          nile_Buffer_t **out_) {
    #define IN_QUANTUM 6
