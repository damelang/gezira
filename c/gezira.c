...
static int gezira_ContrastiveOver_process(nile_t *nl,
    ...
    while (in->i < in->n) {
        ...
        nile_Real_t t_16 = 0;
        nile_Real_t t_17 = t_12 ? t_15 : t_16;
        nile_Real_t t_18 = 1;
        nile_Real_t t_19 = 2;
        ...
        nile_Real_t t_28 = t_21 ? t_24 : t_27;
        nile_Real_t t_29 = 3;
        nile_Real_t t_30 = 4;
        ...
        nile_Real_t t_37 = t_32 ? t_33 : t_36;
        ...
        nile_Real_t t_39 = 1;
        nile_Real_t t_40 = nile_Real_sub(t_39, v_a);
        ...
        nile_Real_t t_43_a = v_a;
        nile_Real_t t_43_r = v_a;
        nile_Real_t t_43_g = v_a;
        nile_Real_t t_43_b = v_a;
        ...
        out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
        nile_Buffer_append(out, t_50_a);
        nile_Buffer_append(out, t_50_r);
        nile_Buffer_append(out, t_50_g);
        nile_Buffer_append(out, t_50_b);
    }
