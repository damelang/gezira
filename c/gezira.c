...
static int gezira_ClipBeziers_process(nile_t *nl,
    ...
    while (in->i < in->n) {
        ...
        nile_Real_t v_cross_x = t_30_x;
        nile_Real_t v_cross_y = t_30_y;
        ...
        if (t_31) {
            ...
            nile_Real_t t_34 = nile_Real_or(v_cross_x, v_cross_y);
            if (t_34) {
...
static int gezira_StrokeJoinMiter_process(nile_t *nl,
    ...
    while (in->i < in->n) {
        ...
        nile_Real_t t_118 = 0;
        nile_Real_t t_119 = nile_Real_lt(t_117, t_118);
        if (t_119) {
            nile_Real_t t_121 = nile_Real_add(v_G_x, v_J_x);
            nile_Real_t t_122 = 2;
            nile_Real_t t_123 = nile_Real_div(t_121, t_122);
            nile_Real_t t_124 = nile_Real_add(v_G_y, v_J_y);
            nile_Real_t t_125 = 2;
            nile_Real_t t_126 = nile_Real_div(t_124, t_125);
            nile_Real_t t_127_1 = t_123;
            nile_Real_t t_127_2 = t_126;
            nile_Real_t t_128_x = t_127_1;
            nile_Real_t t_128_y = t_127_2;
            nile_Real_t t_120_1_x = v_G_x;
            nile_Real_t t_120_1_y = v_G_y;
            nile_Real_t t_120_2_x = t_128_x;
            nile_Real_t t_120_2_y = t_128_y;
            nile_Real_t t_120_3_x = v_J_x;
            nile_Real_t t_120_3_y = v_J_y;
            nile_Real_t t_129_a_x = t_120_1_x;
            nile_Real_t t_129_a_y = t_120_1_y;
            nile_Real_t t_129_b_x = t_120_2_x;
            nile_Real_t t_129_b_y = t_120_2_y;
            nile_Real_t t_129_c_x = t_120_3_x;
            nile_Real_t t_129_c_y = t_120_3_y;
            out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
            nile_Buffer_append(out, t_129_a_x);
            nile_Buffer_append(out, t_129_a_y);
            nile_Buffer_append(out, t_129_b_x);
            nile_Buffer_append(out, t_129_b_y);
            nile_Buffer_append(out, t_129_c_x);
            nile_Buffer_append(out, t_129_c_y);
        }
        else {
            nile_Real_t t_130 = nile_Real_mul(v_u_x, v_w_x);
            nile_Real_t t_131 = nile_Real_mul(v_u_y, v_w_y);
            nile_Real_t t_132 = nile_Real_add(t_130, t_131);
            nile_Real_t t_133 = nile_Real_lt(t_132, v_l);
            if (t_133) {
                nile_Real_t t_134 = nile_Real_mul(v_x_x, v_w_x);
                nile_Real_t t_135 = nile_Real_mul(v_x_y, v_w_y);
                nile_Real_t t_136 = nile_Real_add(t_134, t_135);
                nile_Real_t t_137 = nile_Real_mul(v_d, t_136);
                nile_Real_t v_p = t_137;
                nile_Real_t t_138_x = v_p;
                nile_Real_t t_138_y = v_p;
                nile_Real_t t_139_x = nile_Real_mul(t_138_x, v_x_x);
                nile_Real_t t_139_y = nile_Real_mul(t_138_y, v_x_y);
                nile_Real_t t_140_x = t_139_x;
                nile_Real_t t_140_y = t_139_y;
                nile_Real_t t_141_x = nile_Real_add(v_G_x, t_140_x);
                nile_Real_t t_141_y = nile_Real_add(v_G_y, t_140_y);
                nile_Real_t v_H_x = t_141_x;
                nile_Real_t v_H_y = t_141_y;
                nile_Real_t t_142_x = v_p;
                nile_Real_t t_142_y = v_p;
                nile_Real_t t_143_x = nile_Real_mul(t_142_x, v_y_x);
                nile_Real_t t_143_y = nile_Real_mul(t_142_y, v_y_y);
                nile_Real_t t_144_x = t_143_x;
                nile_Real_t t_144_y = t_143_y;
                nile_Real_t t_145_x = nile_Real_add(v_J_x, t_144_x);
                nile_Real_t t_145_y = nile_Real_add(v_J_y, t_144_y);
                nile_Real_t v_I_x = t_145_x;
                nile_Real_t v_I_y = t_145_y;
                nile_Real_t t_147 = nile_Real_add(v_G_x, v_H_x);
                nile_Real_t t_148 = 2;
                nile_Real_t t_149 = nile_Real_div(t_147, t_148);
                nile_Real_t t_150 = nile_Real_add(v_G_y, v_H_y);
                nile_Real_t t_151 = 2;
                nile_Real_t t_152 = nile_Real_div(t_150, t_151);
                nile_Real_t t_153_1 = t_149;
                nile_Real_t t_153_2 = t_152;
                nile_Real_t t_154_x = t_153_1;
                nile_Real_t t_154_y = t_153_2;
                nile_Real_t t_146_1_x = v_G_x;
                nile_Real_t t_146_1_y = v_G_y;
                nile_Real_t t_146_2_x = t_154_x;
                nile_Real_t t_146_2_y = t_154_y;
                nile_Real_t t_146_3_x = v_H_x;
                nile_Real_t t_146_3_y = v_H_y;
                nile_Real_t t_155_a_x = t_146_1_x;
                nile_Real_t t_155_a_y = t_146_1_y;
                nile_Real_t t_155_b_x = t_146_2_x;
                nile_Real_t t_155_b_y = t_146_2_y;
                nile_Real_t t_155_c_x = t_146_3_x;
                nile_Real_t t_155_c_y = t_146_3_y;
                out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
                nile_Buffer_append(out, t_155_a_x);
                nile_Buffer_append(out, t_155_a_y);
                nile_Buffer_append(out, t_155_b_x);
                nile_Buffer_append(out, t_155_b_y);
                nile_Buffer_append(out, t_155_c_x);
                nile_Buffer_append(out, t_155_c_y);
                nile_Real_t t_157 = nile_Real_add(v_H_x, v_I_x);
                nile_Real_t t_158 = 2;
                nile_Real_t t_159 = nile_Real_div(t_157, t_158);
                nile_Real_t t_160 = nile_Real_add(v_H_y, v_I_y);
                nile_Real_t t_161 = 2;
                nile_Real_t t_162 = nile_Real_div(t_160, t_161);
                nile_Real_t t_163_1 = t_159;
                nile_Real_t t_163_2 = t_162;
                nile_Real_t t_164_x = t_163_1;
                nile_Real_t t_164_y = t_163_2;
                nile_Real_t t_156_1_x = v_H_x;
                nile_Real_t t_156_1_y = v_H_y;
                nile_Real_t t_156_2_x = t_164_x;
                nile_Real_t t_156_2_y = t_164_y;
                nile_Real_t t_156_3_x = v_I_x;
                nile_Real_t t_156_3_y = v_I_y;
                nile_Real_t t_165_a_x = t_156_1_x;
                nile_Real_t t_165_a_y = t_156_1_y;
                nile_Real_t t_165_b_x = t_156_2_x;
                nile_Real_t t_165_b_y = t_156_2_y;
                nile_Real_t t_165_c_x = t_156_3_x;
                nile_Real_t t_165_c_y = t_156_3_y;
                out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
                nile_Buffer_append(out, t_165_a_x);
                nile_Buffer_append(out, t_165_a_y);
                nile_Buffer_append(out, t_165_b_x);
                nile_Buffer_append(out, t_165_b_y);
                nile_Buffer_append(out, t_165_c_x);
                nile_Buffer_append(out, t_165_c_y);
                nile_Real_t t_167 = nile_Real_add(v_I_x, v_J_x);
                nile_Real_t t_168 = 2;
                nile_Real_t t_169 = nile_Real_div(t_167, t_168);
                nile_Real_t t_170 = nile_Real_add(v_I_y, v_J_y);
                nile_Real_t t_171 = 2;
                nile_Real_t t_172 = nile_Real_div(t_170, t_171);
                nile_Real_t t_173_1 = t_169;
                nile_Real_t t_173_2 = t_172;
                nile_Real_t t_174_x = t_173_1;
                nile_Real_t t_174_y = t_173_2;
                nile_Real_t t_166_1_x = v_I_x;
                nile_Real_t t_166_1_y = v_I_y;
                nile_Real_t t_166_2_x = t_174_x;
                nile_Real_t t_166_2_y = t_174_y;
                nile_Real_t t_166_3_x = v_J_x;
                nile_Real_t t_166_3_y = v_J_y;
                nile_Real_t t_175_a_x = t_166_1_x;
                nile_Real_t t_175_a_y = t_166_1_y;
                nile_Real_t t_175_b_x = t_166_2_x;
                nile_Real_t t_175_b_y = t_166_2_y;
                nile_Real_t t_175_c_x = t_166_3_x;
                nile_Real_t t_175_c_y = t_166_3_y;
                out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
                nile_Buffer_append(out, t_175_a_x);
                nile_Buffer_append(out, t_175_a_y);
                nile_Buffer_append(out, t_175_b_x);
                nile_Buffer_append(out, t_175_b_y);
                nile_Buffer_append(out, t_175_c_x);
                nile_Buffer_append(out, t_175_c_y);
            }
            else {
                nile_Real_t t_176 = nile_Real_mul(v_u_x, v_w_x);
                nile_Real_t t_177 = nile_Real_mul(v_u_y, v_w_y);
                nile_Real_t t_178 = nile_Real_add(t_176, t_177);
                nile_Real_t t_179 = nile_Real_div(v_o, t_178);
                nile_Real_t v_q = t_179;
                nile_Real_t t_180_x = v_q;
                nile_Real_t t_180_y = v_q;
                nile_Real_t t_181_x = nile_Real_mul(t_180_x, v_w_x);
                nile_Real_t t_181_y = nile_Real_mul(t_180_y, v_w_y);
                nile_Real_t t_182_x = t_181_x;
                nile_Real_t t_182_y = t_181_y;
                nile_Real_t t_183_x = nile_Real_add(v_C_x, t_182_x);
                nile_Real_t t_183_y = nile_Real_add(v_C_y, t_182_y);
                nile_Real_t v_N_x = t_183_x;
                nile_Real_t v_N_y = t_183_y;
                nile_Real_t t_185 = nile_Real_add(v_G_x, v_N_x);
                nile_Real_t t_186 = 2;
                nile_Real_t t_187 = nile_Real_div(t_185, t_186);
                nile_Real_t t_188 = nile_Real_add(v_G_y, v_N_y);
                nile_Real_t t_189 = 2;
                ...
                nile_Real_t t_184_1_x = v_G_x;
                nile_Real_t t_184_1_y = v_G_y;
                nile_Real_t t_184_2_x = t_192_x;
                nile_Real_t t_184_2_y = t_192_y;
                nile_Real_t t_184_3_x = v_N_x;
                nile_Real_t t_184_3_y = v_N_y;
                nile_Real_t t_193_a_x = t_184_1_x;
                nile_Real_t t_193_a_y = t_184_1_y;
                nile_Real_t t_193_b_x = t_184_2_x;
                nile_Real_t t_193_b_y = t_184_2_y;
                nile_Real_t t_193_c_x = t_184_3_x;
                nile_Real_t t_193_c_y = t_184_3_y;
                out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
                nile_Buffer_append(out, t_193_a_x);
                nile_Buffer_append(out, t_193_a_y);
                nile_Buffer_append(out, t_193_b_x);
                nile_Buffer_append(out, t_193_b_y);
                nile_Buffer_append(out, t_193_c_x);
                nile_Buffer_append(out, t_193_c_y);
                nile_Real_t t_195 = nile_Real_add(v_N_x, v_J_x);
                nile_Real_t t_196 = 2;
                nile_Real_t t_197 = nile_Real_div(t_195, t_196);
                nile_Real_t t_198 = nile_Real_add(v_N_y, v_J_y);
                nile_Real_t t_199 = 2;
                nile_Real_t t_200 = nile_Real_div(t_198, t_199);
                nile_Real_t t_201_1 = t_197;
                nile_Real_t t_201_2 = t_200;
                nile_Real_t t_202_x = t_201_1;
                nile_Real_t t_202_y = t_201_2;
                nile_Real_t t_194_1_x = v_N_x;
                nile_Real_t t_194_1_y = v_N_y;
                nile_Real_t t_194_2_x = t_202_x;
                nile_Real_t t_194_2_y = t_202_y;
                nile_Real_t t_194_3_x = v_J_x;
                nile_Real_t t_194_3_y = v_J_y;
                nile_Real_t t_203_a_x = t_194_1_x;
                nile_Real_t t_203_a_y = t_194_1_y;
                nile_Real_t t_203_b_x = t_194_2_x;
                nile_Real_t t_203_b_y = t_194_2_y;
                nile_Real_t t_203_c_x = t_194_3_x;
                nile_Real_t t_203_c_y = t_194_3_y;
                out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
                nile_Buffer_append(out, t_203_a_x);
                nile_Buffer_append(out, t_203_a_y);
                nile_Buffer_append(out, t_203_b_x);
                nile_Buffer_append(out, t_203_b_y);
                nile_Buffer_append(out, t_203_c_x);
                nile_Buffer_append(out, t_203_c_y);
            }
        }
    }
...
static int gezira_StrokeJoinRound_process(nile_t *nl,
    ...
    while (in->i < in->n) {
        ...
        if (t_119) {
            ...
            nile_Real_t t_131 = nile_Real_mul(v_u_y, v_w_y);
            nile_Real_t t_132 = nile_Real_add(t_130, t_131);
            nile_Real_t t_133 = 0.9;
            nile_Real_t t_134 = nile_Real_lt(t_132, t_133);
            if (t_134) {
                nile_Real_t t_136_x = nile_Real_neg(v_w_x);
                nile_Real_t t_136_y = nile_Real_neg(v_w_y);
                nile_Real_t t_135_1 = v_w_y;
                nile_Real_t t_135_2 = t_136_x;
                nile_Real_t v_z_1 = t_135_1;
                nile_Real_t v_z_2 = t_135_2;
                nile_Real_t t_138_1_x = v_A_x;
                nile_Real_t t_138_1_y = v_A_y;
                nile_Real_t t_138_2_x = v_B_x;
                nile_Real_t t_138_2_y = v_B_y;
                nile_Real_t t_138_3_x = v_C_x;
                nile_Real_t t_138_3_y = v_C_y;
                nile_Real_t t_140_x = v_z_1;
                nile_Real_t t_140_y = v_z_2;
                nile_Real_t t_141_x = nile_Real_add(v_C_x, t_140_x);
                nile_Real_t t_141_y = nile_Real_add(v_C_y, t_140_y);
                nile_Real_t t_142_x = v_z_1;
                nile_Real_t t_142_y = v_z_2;
                nile_Real_t t_143_x = nile_Real_add(v_C_x, t_142_x);
                nile_Real_t t_143_y = nile_Real_add(v_C_y, t_142_y);
                nile_Real_t t_139_1_x = v_C_x;
                nile_Real_t t_139_1_y = v_C_y;
                nile_Real_t t_139_2_x = t_141_x;
                nile_Real_t t_139_2_y = t_141_y;
                nile_Real_t t_139_3_x = t_143_x;
                nile_Real_t t_139_3_y = t_143_y;
                nile_Real_t t_137_1_1_x = t_138_1_x;
                nile_Real_t t_137_1_1_y = t_138_1_y;
                nile_Real_t t_137_1_2_x = t_138_2_x;
                nile_Real_t t_137_1_2_y = t_138_2_y;
                nile_Real_t t_137_1_3_x = t_138_3_x;
                nile_Real_t t_137_1_3_y = t_138_3_y;
                nile_Real_t t_137_2_1_x = t_139_1_x;
                nile_Real_t t_137_2_1_y = t_139_1_y;
                nile_Real_t t_137_2_2_x = t_139_2_x;
                nile_Real_t t_137_2_2_y = t_139_2_y;
                nile_Real_t t_137_2_3_x = t_139_3_x;
                nile_Real_t t_137_2_3_y = t_139_3_y;
                nile_Real_t t_144_1_a_x = t_137_1_1_x;
                nile_Real_t t_144_1_a_y = t_137_1_1_y;
                nile_Real_t t_144_1_b_x = t_137_1_2_x;
                nile_Real_t t_144_1_b_y = t_137_1_2_y;
                nile_Real_t t_144_1_c_x = t_137_1_3_x;
                nile_Real_t t_144_1_c_y = t_137_1_3_y;
                nile_Real_t t_144_2_a_x = t_137_2_1_x;
                nile_Real_t t_144_2_a_y = t_137_2_1_y;
                nile_Real_t t_144_2_b_x = t_137_2_2_x;
                nile_Real_t t_144_2_b_y = t_137_2_2_y;
                nile_Real_t t_144_2_c_x = t_137_2_3_x;
                nile_Real_t t_144_2_c_y = t_137_2_3_y;
                in = nile_Buffer_prepare_to_prepend(nl, in, IN_QUANTUM, k_);
                nile_Buffer_prepend(in, t_144_1_a_x);
                nile_Buffer_prepend(in, t_144_1_a_y);
                nile_Buffer_prepend(in, t_144_1_b_x);
                nile_Buffer_prepend(in, t_144_1_b_y);
                nile_Buffer_prepend(in, t_144_1_c_x);
                nile_Buffer_prepend(in, t_144_1_c_y);
                nile_Buffer_prepend(in, t_144_2_a_x);
                nile_Buffer_prepend(in, t_144_2_a_y);
                nile_Buffer_prepend(in, t_144_2_b_x);
                nile_Buffer_prepend(in, t_144_2_b_y);
                nile_Buffer_prepend(in, t_144_2_c_x);
                nile_Buffer_prepend(in, t_144_2_c_y);
                in->i -= IN_QUANTUM;
                nile_Real_t t_147_x = v_z_1;
                nile_Real_t t_147_y = v_z_2;
                nile_Real_t t_148_x = nile_Real_sub(v_C_x, t_147_x);
                nile_Real_t t_148_y = nile_Real_sub(v_C_y, t_147_y);
                nile_Real_t t_149_x = v_z_1;
                nile_Real_t t_149_y = v_z_2;
                nile_Real_t t_150_x = nile_Real_sub(v_C_x, t_149_x);
                nile_Real_t t_150_y = nile_Real_sub(v_C_y, t_149_y);
                nile_Real_t t_146_1_x = t_148_x;
                nile_Real_t t_146_1_y = t_148_y;
                nile_Real_t t_146_2_x = t_150_x;
                nile_Real_t t_146_2_y = t_150_y;
                nile_Real_t t_146_3_x = v_C_x;
                nile_Real_t t_146_3_y = v_C_y;
                nile_Real_t t_151_1_x = v_D_x;
                nile_Real_t t_151_1_y = v_D_y;
                nile_Real_t t_151_2_x = v_E_x;
                nile_Real_t t_151_2_y = v_E_y;
                nile_Real_t t_151_3_x = v_F_x;
                nile_Real_t t_151_3_y = v_F_y;
                nile_Real_t t_145_1_1_x = t_146_1_x;
                nile_Real_t t_145_1_1_y = t_146_1_y;
                nile_Real_t t_145_1_2_x = t_146_2_x;
                nile_Real_t t_145_1_2_y = t_146_2_y;
                nile_Real_t t_145_1_3_x = t_146_3_x;
                nile_Real_t t_145_1_3_y = t_146_3_y;
                nile_Real_t t_145_2_1_x = t_151_1_x;
                nile_Real_t t_145_2_1_y = t_151_1_y;
                nile_Real_t t_145_2_2_x = t_151_2_x;
                nile_Real_t t_145_2_2_y = t_151_2_y;
                nile_Real_t t_145_2_3_x = t_151_3_x;
                nile_Real_t t_145_2_3_y = t_151_3_y;
                nile_Real_t t_152_1_a_x = t_145_1_1_x;
                nile_Real_t t_152_1_a_y = t_145_1_1_y;
                nile_Real_t t_152_1_b_x = t_145_1_2_x;
                nile_Real_t t_152_1_b_y = t_145_1_2_y;
                nile_Real_t t_152_1_c_x = t_145_1_3_x;
                nile_Real_t t_152_1_c_y = t_145_1_3_y;
                nile_Real_t t_152_2_a_x = t_145_2_1_x;
                nile_Real_t t_152_2_a_y = t_145_2_1_y;
                nile_Real_t t_152_2_b_x = t_145_2_2_x;
                nile_Real_t t_152_2_b_y = t_145_2_2_y;
                nile_Real_t t_152_2_c_x = t_145_2_3_x;
                nile_Real_t t_152_2_c_y = t_145_2_3_y;
                in = nile_Buffer_prepare_to_prepend(nl, in, IN_QUANTUM, k_);
                nile_Buffer_prepend(in, t_152_1_a_x);
                nile_Buffer_prepend(in, t_152_1_a_y);
                nile_Buffer_prepend(in, t_152_1_b_x);
                nile_Buffer_prepend(in, t_152_1_b_y);
                nile_Buffer_prepend(in, t_152_1_c_x);
                nile_Buffer_prepend(in, t_152_1_c_y);
                nile_Buffer_prepend(in, t_152_2_a_x);
                nile_Buffer_prepend(in, t_152_2_a_y);
                nile_Buffer_prepend(in, t_152_2_b_x);
                nile_Buffer_prepend(in, t_152_2_b_y);
                nile_Buffer_prepend(in, t_152_2_c_x);
                nile_Buffer_prepend(in, t_152_2_c_y);
                in->i -= IN_QUANTUM;
            }
            else {
                nile_Real_t t_153_x = v_o;
                nile_Real_t t_153_y = v_o;
                nile_Real_t t_154_x = nile_Real_mul(t_153_x, v_w_x);
                nile_Real_t t_154_y = nile_Real_mul(t_153_y, v_w_y);
                nile_Real_t t_155_x = t_154_x;
                nile_Real_t t_155_y = t_154_y;
                nile_Real_t t_156_x = nile_Real_add(v_C_x, t_155_x);
                nile_Real_t t_156_y = nile_Real_add(v_C_y, t_155_y);
                nile_Real_t v_N_x = t_156_x;
                nile_Real_t v_N_y = t_156_y;
                nile_Real_t t_157 = 2;
                nile_Real_t t_158_x = t_157;
                nile_Real_t t_158_y = t_157;
                nile_Real_t t_159_x = nile_Real_mul(t_158_x, v_N_x);
                nile_Real_t t_159_y = nile_Real_mul(t_158_y, v_N_y);
                nile_Real_t t_160 = nile_Real_add(v_G_x, v_J_x);
                nile_Real_t t_161 = 2;
                nile_Real_t t_162 = nile_Real_div(t_160, t_161);
                nile_Real_t t_163 = nile_Real_add(v_G_y, v_J_y);
                nile_Real_t t_164 = 2;
                nile_Real_t t_165 = nile_Real_div(t_163, t_164);
                nile_Real_t t_166_1 = t_162;
                nile_Real_t t_166_2 = t_165;
                nile_Real_t t_167_x = t_166_1;
                nile_Real_t t_167_y = t_166_2;
                nile_Real_t t_168_x = nile_Real_sub(t_159_x, t_167_x);
                nile_Real_t t_168_y = nile_Real_sub(t_159_y, t_167_y);
                nile_Real_t v_H_x = t_168_x;
                nile_Real_t v_H_y = t_168_y;
                nile_Real_t t_169_1_x = v_G_x;
                nile_Real_t t_169_1_y = v_G_y;
                nile_Real_t t_169_2_x = v_H_x;
                nile_Real_t t_169_2_y = v_H_y;
                nile_Real_t t_169_3_x = v_J_x;
                nile_Real_t t_169_3_y = v_J_y;
                nile_Real_t t_170_a_x = t_169_1_x;
                nile_Real_t t_170_a_y = t_169_1_y;
                nile_Real_t t_170_b_x = t_169_2_x;
                nile_Real_t t_170_b_y = t_169_2_y;
                nile_Real_t t_170_c_x = t_169_3_x;
                nile_Real_t t_170_c_y = t_169_3_y;
                out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
                nile_Buffer_append(out, t_170_a_x);
                nile_Buffer_append(out, t_170_a_y);
                nile_Buffer_append(out, t_170_b_x);
                nile_Buffer_append(out, t_170_b_y);
                nile_Buffer_append(out, t_170_c_x);
                nile_Buffer_append(out, t_170_c_y);
            }
        }
    }
...
typedef struct {
    nile_Kernel_t base;
    nile_Real_t v_w;
} gezira_FilterBegin_t;

static nile_Kernel_t *gezira_FilterBegin_clone(nile_t *nl, nile_Kernel_t *k_) {
    gezira_FilterBegin_t *k = (gezira_FilterBegin_t *) k_;
    gezira_FilterBegin_t *clone = (gezira_FilterBegin_t *) nile_Kernel_clone(nl, k_);
    clone->v_w = k->v_w;
    return (nile_Kernel_t *) clone;
}
...
nile_Kernel_t *gezira_FilterBegin(nile_t *nl, 
                                  nile_Real_t v_w) {
    gezira_FilterBegin_t *k = NILE_KERNEL_NEW(nl, gezira_FilterBegin);
    k->v_w = v_w;
    return (nile_Kernel_t *) k;
}
...
static int gezira_FilterBegin_process(nile_t *nl,
    ...
    while (in->i < in->n) {
        ...
        nile_Real_t t_2 = nile_Real_add(v_y, v_w);
        nile_Real_t t_1_1 = v_x;
        nile_Real_t t_1_2 = t_2;
        nile_Real_t t_3_x = t_1_1;
        nile_Real_t t_3_y = t_1_2;
        out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
        nile_Buffer_append(out, t_3_x);
        nile_Buffer_append(out, t_3_y);
        nile_Real_t t_5 = nile_Real_sub(v_x, v_w);
        nile_Real_t t_4_1 = t_5;
        nile_Real_t t_4_2 = v_y;
        nile_Real_t t_6_x = t_4_1;
        nile_Real_t t_6_y = t_4_2;
        out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
        nile_Buffer_append(out, t_6_x);
        nile_Buffer_append(out, t_6_y);
        nile_Real_t t_7_1 = v_x;
        nile_Real_t t_7_2 = v_y;
        ...
        nile_Real_t t_10 = nile_Real_add(v_x, v_w);
        nile_Real_t t_9_1 = t_10;
        nile_Real_t t_9_2 = v_y;
        nile_Real_t t_11_x = t_9_1;
        nile_Real_t t_11_y = t_9_2;
        out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
        nile_Buffer_append(out, t_11_x);
        nile_Buffer_append(out, t_11_y);
        nile_Real_t t_13 = nile_Real_sub(v_y, v_w);
        nile_Real_t t_12_1 = v_x;
        nile_Real_t t_12_2 = t_13;
...
static nile_Kernel_t *gezira_FilterEnd_clone(nile_t *nl, nile_Kernel_t *k_) {
    gezira_FilterEnd_t *k = (gezira_FilterEnd_t *) k_;
    gezira_FilterEnd_t *clone = (gezira_FilterEnd_t *) nile_Kernel_clone(nl, k_);
    return (nile_Kernel_t *) clone;
}

nile_Kernel_t *gezira_FilterEnd(nile_t *nl) {
    gezira_FilterEnd_t *k = NILE_KERNEL_NEW(nl, gezira_FilterEnd);
    return (nile_Kernel_t *) k;
}
...
static int gezira_FilterEnd_process(nile_t *nl,
    ...
    while (in->i < in->n) {
        ...
        if (t_8) {
            ...
            v_sum__g = t_11_g;
            v_sum__b = t_11_b;
            nile_Real_t t_12_a = nile_Real_add(v_sum_a, v_c_a);
            nile_Real_t t_12_r = nile_Real_add(v_sum_r, v_c_r);
            nile_Real_t t_12_g = nile_Real_add(v_sum_g, v_c_g);
            nile_Real_t t_12_b = nile_Real_add(v_sum_b, v_c_b);
            nile_Real_t t_13 = 6;
            nile_Real_t t_14_a = t_13;
            nile_Real_t t_14_r = t_13;
            nile_Real_t t_14_g = t_13;
            nile_Real_t t_14_b = t_13;
            nile_Real_t t_15_a = nile_Real_div(t_12_a, t_14_a);
            nile_Real_t t_15_r = nile_Real_div(t_12_r, t_14_r);
            nile_Real_t t_15_g = nile_Real_div(t_12_g, t_14_g);
            nile_Real_t t_15_b = nile_Real_div(t_12_b, t_14_b);
            out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
            nile_Buffer_append(out, t_15_a);
            nile_Buffer_append(out, t_15_r);
            nile_Buffer_append(out, t_15_g);
            nile_Buffer_append(out, t_15_b);
        }
        else {
            nile_Real_t t_16 = 1;
            nile_Real_t t_17 = nile_Real_add(v_n, t_16);
            v_n_ = t_17;
            nile_Real_t t_18 = 3;
            nile_Real_t t_19 = nile_Real_eq(v_n, t_18);
            nile_Real_t t_20_a = nile_Real_add(v_sum_a, v_c_a);
            nile_Real_t t_20_r = nile_Real_add(v_sum_r, v_c_r);
            nile_Real_t t_20_g = nile_Real_add(v_sum_g, v_c_g);
            nile_Real_t t_20_b = nile_Real_add(v_sum_b, v_c_b);
            nile_Real_t t_21_a = nile_Real_add(t_20_a, v_c_a);
            nile_Real_t t_21_r = nile_Real_add(t_20_r, v_c_r);
            nile_Real_t t_21_g = nile_Real_add(t_20_g, v_c_g);
            nile_Real_t t_21_b = nile_Real_add(t_20_b, v_c_b);
            nile_Real_t t_22_a = nile_Real_add(v_sum_a, v_c_a);
            nile_Real_t t_22_r = nile_Real_add(v_sum_r, v_c_r);
            nile_Real_t t_22_g = nile_Real_add(v_sum_g, v_c_g);
            nile_Real_t t_22_b = nile_Real_add(v_sum_b, v_c_b);
            nile_Real_t t_23_a = t_19;
            nile_Real_t t_23_r = t_19;
            nile_Real_t t_23_g = t_19;
            nile_Real_t t_23_b = t_19;
            nile_Real_t t_24_a = t_23_a ? t_21_a : t_22_a;
            nile_Real_t t_24_r = t_23_r ? t_21_r : t_22_r;
            nile_Real_t t_24_g = t_23_g ? t_21_g : t_22_g;
            nile_Real_t t_24_b = t_23_b ? t_21_b : t_22_b;
            v_sum__a = t_24_a;
            v_sum__r = t_24_r;
            v_sum__g = t_24_g;
            v_sum__b = t_24_b;
...
typedef struct {
    ...
    nile_Real_t v_w;
    nile_Kernel_t *v_s;
} gezira_FilterSampler_t;

static nile_Kernel_t *gezira_FilterSampler_clone(nile_t *nl, nile_Kernel_t *k_) {
    gezira_FilterSampler_t *k = (gezira_FilterSampler_t *) k_;
    gezira_FilterSampler_t *clone = (gezira_FilterSampler_t *) nile_Kernel_clone(nl, k_);
    clone->v_w = k->v_w;
    clone->v_s = k->v_s->clone(nl, k->v_s);
    return (nile_Kernel_t *) clone;
}
...
static int gezira_FilterSampler_process(nile_t *nl,
    ...
    if (!k_->initialized) {
        k_->initialized = 1;
        ; /* no-op */
        nile_Kernel_t *t_1 = gezira_FilterBegin(nl, v_w);
        nile_Kernel_t *t_2 = nile_Pipeline(nl, v_s, gezira_FilterEnd(nl), NULL);
        nile_Kernel_t *t_3 = nile_Pipeline(nl, t_1, t_2, NULL);
        nile_Kernel_t *f = t_3;
        f->downstream = k_->downstream;
        k_->downstream = f;
    }
...
static int gezira_ImageExtendPad_process(nile_t *nl,
    ...
    nile_Real_t v_D_1 = k->v_D_1;
    nile_Real_t v_D__1;
    nile_Real_t v_D_2 = k->v_D_2;
    nile_Real_t v_D__2;
    
    if (!k_->initialized) {
        k_->initialized = 1;
        nile_Real_t t_2_1 = v_w;
        nile_Real_t t_2_2 = v_h;
        v_D_1 = t_2_1;
        v_D_2 = t_2_2;
    }
    ...
    while (in->i < in->n) {
        ...
        nile_Real_t t_5 = nile_Real_gt(t_4_x, v_P_x);
        nile_Real_t t_6 = t_5 ? t_4_x : v_P_x;
        nile_Real_t t_7 = nile_Real_gt(t_4_y, v_P_y);
        nile_Real_t t_8 = t_7 ? t_4_y : v_P_y;
        nile_Real_t t_9_1 = t_6;
        nile_Real_t t_9_2 = t_8;
        nile_Real_t t_10_x = t_9_1;
        nile_Real_t t_10_y = t_9_2;
        nile_Real_t t_11_x = v_D_1;
        nile_Real_t t_11_y = v_D_2;
        nile_Real_t t_12 = nile_Real_lt(t_10_x, t_11_x);
        nile_Real_t t_13 = t_12 ? t_10_x : t_11_x;
        nile_Real_t t_14 = nile_Real_lt(t_10_y, t_11_y);
        nile_Real_t t_15 = t_14 ? t_10_y : t_11_y;
        nile_Real_t t_16_1 = t_13;
        nile_Real_t t_16_2 = t_15;
        nile_Real_t t_17_x = t_16_1;
        nile_Real_t t_17_y = t_16_2;
        out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
...
static int gezira_ImageExtendRepeat_process(nile_t *nl,
    ...
    while (in->i < in->n) {
        ...
        nile_Real_t v_P_x = nile_Buffer_shift(in);
        nile_Real_t v_P_y = nile_Buffer_shift(in);
        nile_Real_t t_3_x = v_D_1;
        nile_Real_t t_3_y = v_D_2;
        nile_Real_t t_4_x = nile_Real_div(v_P_x, t_3_x);
        nile_Real_t t_4_y = nile_Real_div(v_P_y, t_3_y);
        nile_Real_t v_Q_x = t_4_x;
        nile_Real_t v_Q_y = t_4_y;
        nile_Real_t t_5_x = nile_Real_flr(v_Q_x);
        nile_Real_t t_5_y = nile_Real_flr(v_Q_y);
        nile_Real_t t_6_x = nile_Real_sub(v_Q_x, t_5_x);
        nile_Real_t t_6_y = nile_Real_sub(v_Q_y, t_5_y);
        nile_Real_t t_7_x = v_D_1;
        nile_Real_t t_7_y = v_D_2;
        nile_Real_t t_8_x = nile_Real_mul(t_6_x, t_7_x);
        nile_Real_t t_8_y = nile_Real_mul(t_6_y, t_7_y);
        out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
        nile_Buffer_append(out, t_8_x);
        nile_Buffer_append(out, t_8_y);
        v_D_1 = v_D__1;
...
static int gezira_ImageExtendReflect_process(nile_t *nl,
    ...
    while (in->i < in->n) {
        ...
        nile_Real_t t_7_x = nile_Real_sub(v_Q_x, t_6_x);
        nile_Real_t t_7_y = nile_Real_sub(v_Q_y, t_6_y);
        nile_Real_t t_8 = 0;
        nile_Real_t t_9 = nile_Real_lt(t_7_x, t_8);
        nile_Real_t t_10 = nile_Real_neg(t_7_x);
        nile_Real_t t_11 = t_9 ? t_10 : t_7_x;
        nile_Real_t t_12 = 0;
        nile_Real_t t_13 = nile_Real_lt(t_7_y, t_12);
        nile_Real_t t_14 = nile_Real_neg(t_7_y);
        nile_Real_t t_15 = t_13 ? t_14 : t_7_y;
        nile_Real_t t_16_1 = t_11;
        nile_Real_t t_16_2 = t_15;
        nile_Real_t t_17_x = t_16_1;
        nile_Real_t t_17_y = t_16_2;
        nile_Real_t t_18 = 2;
        nile_Real_t t_19_x = t_18;
        nile_Real_t t_19_y = t_18;
        nile_Real_t t_20 = 1;
        nile_Real_t t_21 = 0;
        nile_Real_t t_22 = nile_Real_neq(t_19_x, t_21);
        nile_Real_t t_23 = t_22 ? t_19_x : t_20;
        nile_Real_t t_24 = nile_Real_div(t_17_x, t_23);
        nile_Real_t t_25 = nile_Real_flr(t_24);
        nile_Real_t t_26 = nile_Real_mul(t_25, t_19_x);
        nile_Real_t t_27 = nile_Real_sub(t_17_x, t_26);
        nile_Real_t t_28 = 1;
        nile_Real_t t_29 = 0;
        nile_Real_t t_30 = nile_Real_neq(t_19_y, t_29);
        nile_Real_t t_31 = t_30 ? t_19_y : t_28;
        nile_Real_t t_32 = nile_Real_div(t_17_y, t_31);
        nile_Real_t t_33 = nile_Real_flr(t_32);
        nile_Real_t t_34 = nile_Real_mul(t_33, t_19_y);
        nile_Real_t t_35 = nile_Real_sub(t_17_y, t_34);
        nile_Real_t t_36_1 = t_27;
        nile_Real_t t_36_2 = t_35;
        nile_Real_t t_37_x = t_36_1;
        nile_Real_t t_37_y = t_36_2;
        nile_Real_t t_38 = 1;
        nile_Real_t t_39_x = t_38;
        nile_Real_t t_39_y = t_38;
        nile_Real_t t_40_x = nile_Real_sub(t_37_x, t_39_x);
        nile_Real_t t_40_y = nile_Real_sub(t_37_y, t_39_y);
        nile_Real_t t_41 = 0;
        nile_Real_t t_42 = nile_Real_lt(t_40_x, t_41);
        nile_Real_t t_43 = nile_Real_neg(t_40_x);
        nile_Real_t t_44 = t_42 ? t_43 : t_40_x;
        nile_Real_t t_45 = 0;
        nile_Real_t t_46 = nile_Real_lt(t_40_y, t_45);
        nile_Real_t t_47 = nile_Real_neg(t_40_y);
        nile_Real_t t_48 = t_46 ? t_47 : t_40_y;
        nile_Real_t t_49_1 = t_44;
        nile_Real_t t_49_2 = t_48;
        nile_Real_t t_50_x = t_49_1;
        nile_Real_t t_50_y = t_49_2;
        nile_Real_t t_51_x = v_D_1;
        nile_Real_t t_51_y = v_D_2;
        nile_Real_t t_52_x = nile_Real_mul(t_50_x, t_51_x);
        nile_Real_t t_52_y = nile_Real_mul(t_50_y, t_51_y);
        out = nile_Buffer_prepare_to_append(nl, out, OUT_QUANTUM, k_);
        nile_Buffer_append(out, t_52_x);
        nile_Buffer_append(out, t_52_y);
        v_D_1 = v_D__1;
        v_D_2 = v_D__2;
    }
...
static nile_Kernel_t *gezira_Gradient_clone(nile_t *nl, nile_Kernel_t *k_) {
    ...
    clone->v_s = k->v_s->clone(nl, k->v_s);
    clone->v_e = k->v_e->clone(nl, k->v_e);
    clone->v_c = k->v_c->clone(nl, k->v_c);
    return (nile_Kernel_t *) clone;
}
